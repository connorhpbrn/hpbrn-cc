...
export function SmoothCursor() {
  ...
  useEffect(() => {
    ...
    function frame(now: number) {
      ...
      // Both translation and rotation use the same fixed-timestep spring so
      // turns ease fluidly instead of snapping. Rotation is a touch softer
      // (lower stiffness, higher damping) for clean direction changes.
